const hostingMessageGlitch = "Demo hosted on a free service of glitch.com and may take up to 30 seconds to wake up"
const hostingMessageHeroku = "Demo hosted on free tier of heroku.com and may take up to 30 seconds to wake up"
export const projectList =[
    {
      ...
      details:["Currency price data generated every 15 minutes from AWS EC2 instance running MT4 (Oanda quotes)", "High Impact News Data retrieved from forex factory", "Node server processes Price and News data and delivers JSON to frontend for consumption with react"],
    ...
    },
    {
      ...
      details:["authenticated users able to Pin, Save, Delete and add images","Unauthenticated users able to view all images","Upload pictures with links","Broken image handling with React","Uses react-masonry-component to handle picture layout"],
    ...
    },
    {
      ...
      details:["able to Update user profile and password", "Manage books in a personalized dashboard","Unauthenticated users able to see all books in circulation","uses Passport.js for Local Authentication","uses Google books api to add books into personal collection"],
    ...
    },
    {
      ...
      details:["Able to detect Invalid Symbols","view up to 10 years of data","uses Socket.io to make Real time updates","uses React-Highcharts to plot charts","uses Quandl API to get stock price historical data"],
    ...
    },
    {
      ...
      details:["Authenticated users can toggle a venue they plan to go to","approximates current location using ip address","Uses YELP's fusion API to find venues","Caches yelp token using memory-cache"],
    ...
    },
    {
      ...
      summary:"View, Create, Update and Delete Polls using a Node/express server",
      details:["able to view and vote on all polls as an Unauthenticated user","able to Share Polls on twitter","uses Basic CRUD with Mongoose","uses passport.js for twitter authentication","Uses D3 for plotting polls","uses redux for improved state management"],
    ...
    },
    {
      ...
      details:["After uploading file, API will respond with uploaded File Size","Uses multer for file processing"],
    ...
    },
    {
      ...
      details:["Given a query, will respond with images returned from Google Image search API","able to vary pagination of the results","responds with the last few Search queries as well"],
    ...
    },
    {
      ...
      details:["Enter any URL and get a JSON response with the Shortened Link","If A link is already shortened, API will not shorten again","stores shortened link using mongoDB","Parses URL for validity"],
    ...
    },
    {
      ...
      details:["given a request, will respond with a JSON object containing the IP Address, Operating System and other info"],
    ...
    },
    {
      ...
      details:["after validating string input server will respond with a JSON object containing the unix stamp and natural date","An introduction to node and express"],
    ...
    },
    {
      ...
      details:["strike areas plotted proportional to strike size","Zoomable map","Uses geoJSON data with D3's geoMercator projection and geo path to build map"],
    ...
    },
    {
      ...
      details:["Able to drag flags and let the simulation take over","Uses D3's forceSimulation","Uses image sprites for flags"],
    ...
    },
    {
      ...
      details:["Uses a variation of D3's bar chart","Uses temperature range to create color scales"],
    ...
    },
    {
      ...
      details:["labels each athlete's allegation independently","Uses a variation of D3's scatter chart"],
    ...
    },
    {
      ...
      details:["An intro to basic data visualization using D3.js V4","Adds tooltip to individual bars","Uses D3's built-in Json capabilities to read data","Uses temporal scale for x-axis"],
    ...
    },
    {
      ...
      details:["no two dungeons will have the same floor plan","flood fill algorithm removes disjointed caves","Complex react state management","Uses Celluar Automata to generate a floor plan"],
    ...
    },
    {
      ...
      details:["Able to change grid size and speed of generation","Will wrap new live cells created at the grid boundaries","can manually add live cells","play, pause and reset generations","Integrated setinterval with react state management"],
    ...
    },
    {
      ...
      details:["Create, read, update and delete recipes","intermediate state management","save recipes in browser's local storage","Use react parent-child components concept"],
    ...
    },
    {
      ...
      details:["sortable by two different components of the dataset","Add AJAX calls to react components","Basic state management","used react Component to build body of HTML table"],
    ...
    },
    {
      ...
      details:["an Introduction to react","uses sass to create css file","Imports and Uses Marked library"],
    ...
    },
    {
      ...
      details:["Able to play in 'strict' mode", 'Times out on delayed user responses','Increases in difficulty as user progresses',"Advanced use of settimeout and setinterval","Built with jQuery and SVG only"],
    ...
    },
    {
      ...
      details:["game made to be challenging but beatable","Optimizes computer's move with standard strategies","Can play a series of games and scores will be kept until reset","Built with jQuery and SVG only",],
    ...
    },
    {
      ...
      details:["Custom circular progress bar display","Audible at the end of each cycle","Built with jQuery and HTML5 canvas only","Basic Usage of setintervals with callbacks"],
    ...
    },
    {
      ...
      details:["Has secondary screen for numbers in memory","Does basic mathematical operations","Validates input to avoid screen overflow","Uses an HTML table with css formatting for display"],
    ...
    },
    {
      ...
      details:["Able to Filter by users that are online or offline","Dynamic link of results to the respective user's Twitch.tv channel","Makes Multiple, nested AJAX requests","uses an HTML table with css formatting to Display results"],
    ...
    },
    {
      ...
      summary:"an online interface for making Wikipedia searches and displaying the results",
      details:["Able to pull a random Wikipedia article","Results linked to respective Wikipedia pages","Makes multiple AJAX requests to Wikipedia's API","Uses jQuery to dynamically create HTML elements"],
    ...
    },
    {
      ...
      details:["Able to convert between Celsius/Fahrenheit","Uses geolocation API","Uses google's reverse geocode API to get city information","Makes basic AJAX requests to A weather API","Imports script to animate weather icons"],
    ...
    },
    {
      ...
      summary:"Displays a simple quote generator that retrieves quotes from an online API",
      details:["Able to tweet retrieved quotes","uses jQuery to Make basic AJAX requests","uses css bootstarp to Format quote display"],

        ...
        <div className="skillholder">
          ...
          <div className="alliconholder">
            ...
            <figure className="figflex">
              <img
                className="skillicons"
                src="./images/icons/matplotlib.png"
                alt=""
              />
          ...
          <div className="alliconholder">
            ...
            <figure className="figflex">
              <img
                className="skillicons"
                src="./images/icons/powershell.png"
                alt=""
              />
